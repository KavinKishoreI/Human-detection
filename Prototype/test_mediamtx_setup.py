...
print("  2. ✓ YOLO analyzer is waiting for rtsp://localhost:8554/dji")
...
print("  RTMP: rtmp://<YOUR_PC_IP>:1935/dji")
...
print("     Server: rtmp://localhost:1935/dji")
...
print("  Set destination to: rtsp://localhost:8554/dji")
print()
...
print(f"  RTMP URL: rtmp://{local_ip}:1935/dji")
print(f"  RTSP URL: rtsp://{local_ip}:8554/dji")
print()
print("=" * 60)
print()

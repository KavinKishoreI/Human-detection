...
# --- CONFIGURATION ---
# Import video source from config file (auto-generated by run_project.ps1)
try:
    from config import VIDEO_SOURCE
    print(f"📹 Video Source from config: {VIDEO_SOURCE}")
except ImportError:
    # Default to webcam if config doesn't exist
    VIDEO_SOURCE = 0
    print(f"📹 Video Source (default): {VIDEO_SOURCE}")

# VIDEO_SOURCE Options:
# - For webcam: 0 (default camera), 1 (second camera), etc.
# - For DJI Drone RTMP→RTSP: "rtsp://localhost:8554/drone"
# - For custom RTSP: "rtsp://192.168.1.100:8554/stream"
